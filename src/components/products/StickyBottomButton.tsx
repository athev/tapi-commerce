...
const StickyBottomButton = ({
  ...
  return <div className="fixed bottom-0 left-0 right-0 bg-background border-t shadow-2xl z-50 safe-area-pb">
      <div className="flex items-center gap-2 p-2">
        {/* Chat Button */}
        <Button variant="outline" className="h-12 px-3 sm:px-4 flex items-center gap-2 flex-1">
